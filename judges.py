...
from language_models import GLM


def load_judge(args):
    if "glm" in args.judge_model:
...
class GPTJudge(JudgeBase):
    def __init__(self, args):
        ...
        self.judge_model = GLM(model_name=self.judge_name)
    ...
    def score(self, attack_prompt_list, target_response_list):
        convs_list = [self.create_conv(self.get_judge_prompt(prompt, response)) for prompt, response in
