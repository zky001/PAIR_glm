...
def main(args):
    ...
    for iteration in range(1, args.n_iterations + 1):
        ...
        if '404' in target_response_list:
            judge_scores = [0, 0, 0, 0, 0]
        else:
            # Get judge scores
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        choices=["glm", "vicuna", "llama-2", "gpt-3.5-turbo", "gpt-4", "claude-instant-1", "claude-2", "palm-2"]
    )
    parser.add_argument(
        "--attack-max-n-tokens",
        type=int,
    ...
    parser.add_argument(
        ...
        choices=["gpt-3.5-turbo", "gpt-4", "glm"]
    )
    parser.add_argument(
        "--judge-max-n-tokens",
        type=int,
